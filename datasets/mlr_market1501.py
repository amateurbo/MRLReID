...
class MLR_Market1501(BaseImageDataset):
    dataset_dir = 'MLR_Market1501'

    def __init__(self, root='', verbose=True, pid_begin = 0, **kwargs):
        super(MLR_Market1501, self).__init__()
    ...
    def _process_dir(self, dir_path, relabel=False):
        ...
        for imgname in tqdm.tqdm(imgnames):
            ...
            pid = int(imgname.split('_')[0]) - 1
            # camid = int(imgname.split('_')[1]) - 1
            camid = int(imgname.split('_')[1][1]) - 1
